				...
				<div class="widget-box">
					...
					<div class="widget-inner" id="table__scroll">
						<table class="table small">
							...
							<tbody>
								<?php $posts = $db->query("SELECT * FROM enroll"); ?>
								<?php foreach ($posts as $item) : ?>
									<tr>
										<td><?php echo $item['course_id']; ?></td>
										<td><?php echo $item['guest_apply_id']; ?></td>
										<td><?php echo $item['bought_at']; ?></td>
										<td>
											<?php
											if ($item['status'] <= 0) { ?>
												<button  class="btn btn-primary btn-sm  approve-btn" id="<?php echo $item['enrollid']; ?>" >Unapprove <span class="badge badge-light"></button>
											<?php } else { ?>
												<a href="javascript:void(0);" class="btn btn-primary btn-sm " id="<?php echo $item['enrollid']; ?>">Done</a>
											<?php } ?>
										</td>
									</tr>
								<?php endforeach; ?>
